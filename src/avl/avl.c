...
int avl_get_by_key(avl_tree *tree : itype(_Ptr<avl_tree> ) , void *key, void **value_address)
{
...
int avl_delete(avl_tree *tree : itype(_Ptr<avl_tree> ) , void *key, _Ptr<int (void* )> free_key_fun)
{
...
int avl_get_span_by_two_keys(_Ptr<avl_tree> tree, void *low_key, void *high_key, _Ptr<unsigned long> low, _Ptr<unsigned long> high)
{
  unsigned long i, j;
